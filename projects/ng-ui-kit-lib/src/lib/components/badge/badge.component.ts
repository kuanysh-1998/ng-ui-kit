...
export class BadgeComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  @Input() public icon: Icons | undefined;
  @Input() public iconRight: Icons | undefined;
  ...
  @ViewChild("badgeText", { static: true })
  ...
  private _checkOverflow(): void {
    ...
    this.isOverflowing.set(
      textElement.offsetHeight > badgeElement.offsetHeight
    );
  }
}
